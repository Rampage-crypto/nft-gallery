    ...
    <div className={`card bordered max-w-xs compact rounded-md transition duration-300 transform hover:opacity-75 cursor-pointer hover:scale-105`}>
      ...
      <div className="absolute top-2 right-2">
        <div className="flex flex-col">
          <div className="tooltip tooltip-left rounded-full" data-tip="Download">
            <div className="linear-gradient-puls-full-hover rounded-full p-px bg-black">
              <div className="App">
                <a href={image} download target="_blank">
                  <button className="button button-primary text-white p-2 rounded-full text-xl flex items-center">
                    <svg xmlns={image} fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="false" className="h-6 w-6 text-white-500">
